...
We then computed the bigrams of every class individually. An initial analysis reveals an overlap in top bigrams across all three sentiments. Combinations relating to reporting currencies, figures, and standard financial terms (e.g., "eur num", "num mn", "net sale") dominate the frequencies everywhere. This indicates that general financial vocabulary alone is sentiment-neutral; a classifier cannot rely on terms like "operating profit" or "net sale" by themselves to make a prediction, as they appear consistently regardless of sentiment.  
